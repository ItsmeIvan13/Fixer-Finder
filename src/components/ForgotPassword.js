    ...
    return ( 
        <div className="container mx-auto p-3 flex flex-col justify-center items-center pt-16">
           ...
           <MdMarkEmailRead className="w-36 h-36 text-primary " />
            ...
            <p className="text-base font-sans font-small py-6">Enter your valid email address.</p>

            <form className="w-full">
            <label>Email</label> 
            <input type='email' className='w-full px-3 py-2 text-md font-medium border border-grey-200 rounded-md focus:outline-green-500 ' required/>
            </form>
